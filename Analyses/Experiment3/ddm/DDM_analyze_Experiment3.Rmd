...
Distance_Fixed_250 = sqrt((mean(conditions_drift$Drift_Accuracy_Fixed_ISI250) - (mean(conditions_drift$Drift_Speed_Fixed_ISI250)))**2 + (mean(conditions_threshold$Threshold_Accuracy_Fixed_ISI250) - mean(conditions_threshold$Threshold_Speed_Fixed_ISI250))**2)
...
Distance_Fixed_1000 = sqrt((mean(conditions_drift$Drift_Accuracy_Fixed_ISI1000) - (mean(conditions_drift$Drift_Speed_Fixed_ISI1000)))**2 + (mean(conditions_threshold$Threshold_Accuracy_Fixed_ISI1000) - mean(conditions_threshold$Threshold_Speed_Fixed_ISI1000))**2)
