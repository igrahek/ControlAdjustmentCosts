...
### Fit the RT model
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
model.RT = brm(AccRT ~ Congruency + isi*intervalType * blockType + scaledIntervalSessionNum + scaledIntervalLength +scaledRunningTime + (Congruency + isi*intervalType * blockType|uniqueid),
                                        data=df.trial,
                                        family=exgaussian(),
                                        #prior = prior,
                                        cores = 4,
