...
df.trial.raw = read.csv('../data/RawData/Version7/2022-11-29_2.0/trialdata_reconf_isi_2022-11-29.csv')
...
data.prolific = read.csv("../data/RawData/Version7/2022-11-29_2.0/prolific_export_636dbf93624dfcd33f6d98bd.csv")

# Load in the attention quiz data
df.quiz = read.csv('../data/RawData/Version7/2022-11-29_2.0/questiondata_reconf_isi_2022-11-29.csv') %>% 
  separate(col = uniqueid, sep = ":", c("SubID","Version"), remove = FALSE) %>%
...
write.csv(preproSummary, file = "PreprocessingSummary_Experiment7.csv")